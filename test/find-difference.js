var findTheDifference = require('../src/find-difference');
var assert = require('assert');
describe('find-difference', function () {
    describe('#findTheDifference()', function () {
        it('should return e when s is abcd and t is abcde', function () {
            var result = findTheDifference('abcd', 'abcde');
            assert.equal('e', result);
        });
        it('should return t when s is ym... and t is qh...', function () {
            var result = findTheDifference(
