...
function minIndex(arr, idx0, idx1) {
...
class MinHeap {
    ...
    pop() {
        ...
        while (idx <= this.length - 1) {
            ...
            let minLeftRight = minIndex(this.arr, left, right);
            if (this.arr[idx].value <= this.arr[minLeftRight].value) {
                break;
            }
            swap(this.arr, idx, minLeftRight);
            idx = minLeftRight;
        }
        return top;
    }
